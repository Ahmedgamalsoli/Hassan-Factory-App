...
############################ Init ########################################################
    ...
    def __init__(self, root):
        ...
        self.translations = {
            ...
            "Receive Payment": {"Arabic": "حسابات وتوريدات العملاء", "English": "Customer accounts and supplies"},
            "Treasury": {"Arabic": "الخزينة", "English": "Treasury"},
            "Make Payment": {"Arabic": "حسابات وتوريدات الموردين", "English": "Supplier accounts and supplies"},
            ...
            "Employee Statistics":{"Arabic": "احصائيات الموظفين", "English": "Employee Statistics"},
        }
...
############################################ Windows ########################################### 
    ...
    def manage_Employees_window(self,user_role):
        ...
        buttons = [
            ...
            "command": lambda: self.trash(self.user_role)},
            {"text": self.t("Employee Time Statistics"), "image": "employee time statistics.png", 
            "command": lambda: self.trash(self.user_role)},
        ]
        images = []  # Keep references to prevent garbage collection
