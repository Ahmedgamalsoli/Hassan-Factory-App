    ...
    def generate_pdf(self, invoice_data):
        ...
        try:
            ...
            for line in customer_fields:
                ...
                c.drawRightString(width - 2*cm, customer_y, format_arabic(line))
                customer_y -= 0.8*cm
            ...
            totals = [
                f"صافي الفاتورة: {invoice_data['Net_total']}",
                f"حساب سابق: {invoice_data['Previous_balance']}",
                f"إجمالي الفاتورة:" {invoice_data['Net_total']+  invoice_data.get('Previous_balance', 0)}",
                f"المدفوع: {invoice_data.get('Payed_cash', 0)}",
                f"اسم العميل: {invoice_data['Net_total'] + invoice_data.get('Previous_balance', 0)) - invoice_data.get('Payed_cash', 0)}",
