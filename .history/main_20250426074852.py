...
############################ Init ########################################################
    ...
    def __init__(self, root):
        ...
        self.translations = {
            ...
            "Change Language": {"Arabic": "فاتورة مشتريات جديدة", "English": "New Purchase Invoice"},
            "Change Language": {"Arabic": "استلام دفعة", "English": "Receive Payment"},
            "Change Language": {"Arabic": "دفع دفعة", "English": "Make Payment"},
            # "Change Language": {"Arabic": "تغيير اللغة", "English": "Change Language"},
            # "Change Language": {"Arabic": "تغيير اللغة", "English": "Change Language"},
            # "Change Language": {"Arabic": "تغيير اللغة", "English": "Change Language"},
            # "Change Language": {"Arabic": "تغيير اللغة", "English": "Change Language"},
...
############################################ Windows ########################################### 
    ...
    def main_menu(self):
        ...
        buttons = [
            {"text": self.t("New Sales Invoice"), "image": "Exit.png", 
