...
############################ Utility Functions ########################################
    ...
    def save_invoice(self, sales_col, customers_col, products_col):
        ...
        try:
            ...
            payed_cash = self.payed_cash_var.get() or 0.0
            if payed_cash < 0:
            ...
            pdf_path = self.generate_pdf({
                **invoice_data,
                ...
                "Payed_Method": self.payment_method_var.get()
            })
            ...
            sales_col.insert_one({
                ...
                "Customer_info": {
                    ...
                    "phone": customer.get("Phone_number1"),
            ...
            messagebox.showinfo("نجاح", f"تم حفظ الفاتورة رقم {invoice_number}")
