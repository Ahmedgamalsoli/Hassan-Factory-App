...
############################ Utility Functions ########################################
    ...
    def generate_pdf(self, invoice_data):
        ...
        # تحديد مواقع الأعمدة
        label_x = width - 6*cm  # موقع التسميات
        value_x = width - 4*cm   # موقع الأرقام
        ...
        for label, value in totals:
            ...
            c.drawRightString(label_x, totals_y, format_arabic(label))
            
            # رسم القيمة على اليسار
            c.drawString(value_x, totals_y, format_arabic(f"{value:,.2f}"))
