    ...
    def generate_pdf(self, invoice_data):
        ...
        try:
            ...
            totals = [
                ...
                f"اسم العميل: {invoice_data['Previous_balance']}",
                f"اسم العميل: {invoice_data['Net_total']+  invoice_data.get('Previous_balance', 0)}",
                f"اسم العميل: {invoice_data.get('Payed_cash', 0)}",
