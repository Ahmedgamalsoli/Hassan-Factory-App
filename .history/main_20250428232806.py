...
############################################ Windows ########################################### 
    ...
    def new_sales_invoice(self, user_role):
        ...
        def create_row(parent, row_number, bg_color):
            row_frame = tk.Frame(parent, bg=bg_color)  # Set frame background
        ...
        def add_three_rows():
            ...
            for i in range(3):
                # Calculate global row index for proper alternation
                global_row_num = current_row_count + i
                bg_color = '#ffffff' if global_row_num % 2 == 0 else '#f0f0f0'
                row_entries = create_row(self.rows_frame, global_row_num, bg_color)
