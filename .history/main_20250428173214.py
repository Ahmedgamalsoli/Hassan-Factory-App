...
############################################ Windows ########################################### 
    ...
    def new_sales_invoice(self, user_role):
        ...
        col_width = 18  # Consistent width for all columns
        ...
        for idx, col in enumerate(columns):
            tk.Label(header_frame, text=col, width=col_width, relief='ridge',
                    bg='#f0f0f0', padx=5, anchor='w').grid(row=0, column=idx, sticky='ew')
