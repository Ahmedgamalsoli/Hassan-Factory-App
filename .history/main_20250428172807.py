    ...
    def new_sales_invoice(self, user_role):
        ...
        def add_three_rows():
            ...
            for i in range(3):
                ...
                row_frame.grid(row=current_row_count+i, column=0, sticky='ew', padx=1, pady=1)
                
                for col_idx in range(len(columns)):
                    entry = tk.Entry(row_frame, width=30, relief='sunken', bg='white' if current_row_count+i % 2 == 0 else '#f8f8f8')
