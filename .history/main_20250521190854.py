...
############################################ Windows ########################################### 
    ...
    def get_top_client(self):
        try:
            pipeline = [
                # Convert Credit string to a numeric value (extract part before '_')
                {
                    "$addFields": {
                        "creditNumeric": {
                            "$toDouble": {
                ...
                # Sort by the numeric credit value in descending order
            ...
            if result:
                # Return the client's name and highest credit value
